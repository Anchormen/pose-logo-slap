...
`docker build -t poselogoslap:latest https://raw.githubusercontent.com/Anchormen/pose-logo-slap/develop/Dockerfile.cpu`

or for GPU:

`docker build -t poselogoslap:latest https://raw.githubusercontent.com/Anchormen/pose-logo-slap/develop/Dockerfile.cuda10_1.gpu`
